export const newConstitution = `Конституция Республики Казахстан
Мы, народ Казахстана,
...
3. Положения Конституции Респуб­лики Казахстан о формировании Палат Парламента применяются начиная с выборов депутатов Мажилиса Парламента восьмого созыва.`